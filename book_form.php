        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td>Extra Accommodation <input type="hidden" name="accommodation_sub" value="0"></td>
    ...
    $(function(){
        ...
        $('#book-form').submit(function(e){
            ...
            $.ajax({
                ...
                error:err=>{
                    console.log(err)
                    alert_toast("Please give correct details",'error')
                    end_loader()
                },
                success:function(resp){
                    if(typeof resp == 'object' && resp.status == 'success'){
                        alert_toast("Booking Request sent.")
                        $('.modal').modal('hide')
                    }else{
                        console.log(resp)
                        alert_toast("Oops! Something went wrong",'error')
                    }
                    end_loader()
                }
            })
