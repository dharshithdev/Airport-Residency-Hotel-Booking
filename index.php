 ...
 <?php require_once('inc/header.php') ?>
  ...
  <div class="modal fade text-dark rounded-0" id="uni_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
      ...
      <div class="modal-footer">
        <strong><p>*You can also reserve room by pre-paying, For payment please use this UPI ID <b>bashi558755@okhdfcbank.</b></p></strong>
        <button type="button" class="btn btn-primary" id='submit' onclick="$('#uni_modal form').submit()">Confirm Booking</button>
